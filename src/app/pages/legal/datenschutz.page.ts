    ...
    template: `
        <div class="page">
            <div class="card card-pad">
                ...
                <p class="small" style="margin:0;">Bitte anpassen, je nachdem ob du Tracking, Formulare oder externe
                    Inhalte nutzt.</p>
            </div>
            ...
            <div class="card card-pad" style="margin-top: 14px;">
                ...
                <p style="margin:0; color: var(--muted); line-height:1.7;">
                    Platzhalter: Nenne hier deinen Hoster (z. B. Vercel/Netlify) und beschreibe kurz, welche Daten
                    verarbeitet werden.
                </p>
                ...
                <p style="margin:0; color: var(--muted); line-height:1.7;">
                    Wenn du ein Kontaktformular einbaust, musst du hier genauer werden. Aktuell: nur Links (E-Mail,
                    GitHub, LinkedIn).
                </p>
            </div>
        </div>
